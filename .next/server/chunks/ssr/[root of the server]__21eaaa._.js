...
;
const doc = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$google$2d$spreadsheet$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GoogleSpreadsheet"](process.env.GOOGLE_SHEETS_SPREADSHEET_ID);
...
const Field = ({ field, onChange, sectionId, date })=>{
    const handleChange = async (value)=>{
        ...
        if (field.id !== 'notes') {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateField"])(date, sectionId, field.id, value);
            } catch (error) {
...
const UpdateButton = ({ onUpdate, isYesterday, sections, date })=>{
    ...
    const handleUpdate = async ()=>{
        setIsUpdating(true);
        try {
            // Obtener las notas de la sección correspondiente
            const notesSection = sections.find((s)=>s.id === 'notes');
            const notes = notesSection?.fields[0].value;
            // Actualizar solo las notas
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$spreadsheet$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateNotes"])(date, notes);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__21eaaa._.js.map